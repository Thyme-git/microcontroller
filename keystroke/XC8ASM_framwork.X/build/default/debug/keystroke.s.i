...
# 47 "/opt/v6.10/packs/Microchip/PIC16F1xxxx_DFP/1.18.352/xc8/pic/include/proc/pic16f18854.inc"
INDF0 equ 0000h
...
# 8 "/opt/v6.10/packs/Microchip/PIC16F1xxxx_DFP/1.18.352/xc8/pic/include/pic.inc"
stk_offset SET 0
auto_size SET 0
...
comf WPUA; WPUA <- 0xff
banksel ANSELA
clrf ANSELA; ANSELA <- 0x00

;segment config
banksel TRISB
clrf TRISB; port b as output
banksel TRISC
clrf TRISC; port c as negtive pole

; interupt config
banksel INTCON
bsf ((INTCON) and 07Fh), 7 ;enable general interupt
banksel PIE0
bsf ((PIE0) and 07Fh), 5; enable Timer0 interupt
;TIMER0 config
banksel T0CON0
...
movlw 128;
subwf rcnt, w;
btfsc STATUS, 2; if rcnt != 128, skip
...
movf key_buffer, w;
andlw 00001111B; w <- key_buffer & 00001111B
...
banksel TRISA
movlw 0x0f
movwf TRISA; TRISA <- 0x0f
clrf PORTA; PORTA <- 0x00; set output low
movlw 0x08
...
movwf LATC ; LATC <- seg_select[seg_idx%4]

movf seg_flash, w
btfsc seg_idx, 7
iorwf LATC, f ; flash, if seg_flash[i] == 1, then LATC[i] will be set as 1
return
;========================seg_display_func===================================
